...
//        OAuthTokens =  oae.GetUserAccessKeySecret();
    ...
    */
    ...
    public static JSONArray testmain()
    {
    ...
    public static String readFiletest(String filename)
{
   String content = null;
   ...
   return content;
    ...
    {
         String resultsf =   readFiletest("searchresults.json");
         //JSONArray ress = new JSONArray(resultsf); 
         JSONArray got = testmain();
         assertNotSame("Return Null", got,resultsf);
