...
import Chapter2.restapi.RESTApiExample;
import Chapter2.restapi.RESTSearchExample;
import java.io.File;
...
public class unittest
{
    ...
    HashSet<String> Userids;
     static RESTSearchExample rse2 = new RESTSearchExample();
    
    
      public static void testGetConsumer()
    {
        //assertNotNull("Return Null",rse2.GetConsumer() );
        
    }
      public static void testLoadTwitterToken()
    {
        rse2.LoadTwitterToken();
         assertNotNull("Return Null", rse2.OAuthTokens);
    }
    
    
    
    public static void testGetRateLimitStatus()
    {
        
         assertNotNull("Return Null", rse2.GetRateLimitStatus());
    }
    
    
    public static void testInitializeWriters()
    {
        rse2.InitializeWriters("abc");
    ...
    public static void testWriteToFile()
    {
         ...
         //assertNull("Return NotNull", rse.WriteToFile());
    }
...
//        OAuthTokens =  oae.GetUserAccessKeySecret();
    ...
    */
    ...
    public static void main(String[] args)
    {
      ...
      testLoadTwitterToken();
   
    
     //testGetSearchResults();
    
    
    testGetRateLimitStatus();
   
    
    
    testInitializeWriters();
    ...
    testWriteToFile();
       ...
       // for(int ii=1;ii<5;ii++)
        ...
        assertNotNull("Return Null", results);
        if(results!=null)
        {
