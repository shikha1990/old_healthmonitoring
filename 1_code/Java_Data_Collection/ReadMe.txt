Readme 
The data collection of the twitter data is done under the Netbeans java IDE. The main class of this should be the unit test class of the unit test package .
