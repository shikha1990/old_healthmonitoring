 ...
 * @author shamanth
 */
package Crawler.openauthentication;
...
{        
    ...
    {
        String accesstoken = "1588047948-Y1uss1iZafQYnBuaOVY3jzPoEBHCgIfst7JbFDw";
        String accesssecret = "6XU1ehBD4BPFmJaGR0VHBcd1yqaaIsqwvQERZzA";
        OAuthTokenSecret tokensecret = new OAuthTokenSecret(accesstoken,accesssecret);
        return tokensecret;
    }
